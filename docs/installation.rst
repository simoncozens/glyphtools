...
The sources for glyphtools can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/simoncozens/glyphtools
.. _tarball: https://github.com/simoncozens/glyphtools/tarball/master
